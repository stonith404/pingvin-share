...
const Upload = ({
    ...
    useEffect(() => {
        ...
        if (fileErrorCount > 0) {
            if (!errorToastShown) {
                toast.error(
                    intl.formatMessage({id: "upload.notify.count-failed"}, {count: fileErrorCount}),
                    {
        ...
        if (
            ...
            shareService
                ...
                .catch(() =>
                    toast.error(intl.formatMessage({id: "upload.notify.generic-error"}))
                );
        }
    }, [files]);
    ...
    return (
        <>
            <Meta title={intl.formatMessage({id:"upload.title"})} />
