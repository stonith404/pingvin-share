export default {
  ...
  "account.modal.unlink.description": "Die Aufhebung der Verknüpfung mit Ihren sozialen Konten kann dazu führen, dass Sie Ihr Konto verlieren, wenn Sie sich nicht an Ihren Benutzernamen und Ihr Passwort erinnern.",
  ...
  "account.reverseShares.modal.send-email.description": "Sendet eine E-Mail Benachrichtigung, wenn eine Datei auf einer externen Freigabe hochgeladen wurde.",
  ...
  "admin.config.email.enable-share-email-recipients.description": "Gibt an, ob E-Mails an Freigabe-Empfänger ermöglicht werden sollen. Aktiviere dies nur, wenn Du SMTP aktivierst hast.",
  ...
  "admin.config.email.reverse-share-subject.description": "Betreff der E-Mail, die gesendet wird, wenn jemand eine Datei mit deinem externen Freigabe-Link hochlädt.",
  ...
  "admin.config.ldap.bind-dn.description": "Standardbenutzer, der zur Ausführung der Benutzersuche verwendet wird",
  "admin.config.ldap.bind-password": "Binde Passwort",
  "admin.config.ldap.bind-password.description": "Passwort, der zur Ausführung der Benutzersuche verwendet wird",
