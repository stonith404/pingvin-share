export default {
  ...
  "admin.config.s3.enabled.description": "Kann aktiviert werden um Dateien in S3 Eimer zu speichern.",
  "admin.config.s3.endpoint": "Endpunkt",
  "admin.config.s3.endpoint.description": "Die URL/Host des S3 Eimers.",
  "admin.config.s3.region": "Region",
  "admin.config.s3.region.description": "Die Region in dem sich der S3 Eimer befindet.",
  "admin.config.s3.bucket-name": "Eimer Name",
  "admin.config.s3.bucket-name.description": "Der Name des S3 Eimers",
  "admin.config.s3.bucket-path": "Pfad",
  "admin.config.s3.bucket-path.description": "Der Standard Pfad welcher beim S3 Eimer verwendet werden soll.",
  "admin.config.s3.key": "Schlüssel",
  "admin.config.s3.key.description": "Der Schlüssel welcher verwendet wird für den Zugriff auf den S3 Eimer.",
  "admin.config.s3.secret": "Geheimnis",
  "admin.config.s3.secret.description": "Das Geheimnis welches verwendet wird für den Zugriff auf den S3 Eimer.",
  // 404
