export default {
  ...
  "admin.config.smtp.allow-unauthenticated-certificates": "Vertrauen von nicht authentifizierten SMTP-Server-Zertifikaten",
  "admin.config.smtp.allow-unauthenticated-certificates.description": "Verwenden Sie diese Option nur, wenn Sie selbst signierten Zertifikaten vertrauen müssen.",
