export default {
  ...
  "admin.config.general.secure-cookies.description": "Kas küpsistele seata turvalisuse lipp. Kui see on lubatud, ei tööta sait HTTP kaudu.",
  ...
  "admin.config.oauth.oidc-username-claim.description": "Kasutajanime väide OpenID Connect ID tokenis. Jäta tühjaks, kui sa ei tea, mis see seade on.",
