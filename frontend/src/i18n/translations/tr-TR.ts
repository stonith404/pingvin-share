export default {
  ...
  "admin.config.cache.ttl.description": "Önbellekte bilgiyi tutma süresi (saniye cinsinden).",
  ...
  "admin.config.cache.redis-enabled": "Redis etkinleştirildi",
  "admin.config.cache.redis-enabled.description": "Normalde Pingvin Share, bilgileri bellekte önbelleğe alır. Eğer birden fazla Pingvin Share örneği çalıştırıyorsanız, önbelleği örnekler arasında paylaşmak için Redis önbelleğini etkinleştirmeniz gerekir.",
  "admin.config.cache.redis-url": "Redis URL",
  "admin.config.cache.redis-url.description": "Önbellek için kullanılan Redis örneğine bağlanmak için Url.",
