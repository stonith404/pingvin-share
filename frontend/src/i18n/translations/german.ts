...
export const german = {
  ...
  "home.description":
    "Möchten Sie Ihre persönlichen Dateien wirklich in die Hände von Dritten wie WeTransfer geben?",
  "home.bullet.a.name": "Selbst gehostet",
  "home.bullet.a.description":
    "Hosten Sie Pingvin Share auf Ihrem eigenen Rechner.",
  ...
  "home.bullet.c.description":
    "Laden Sie so große Dateien hoch, wie Sie möchten. Nur Ihre Festplatte wird Ihr Limit sein.",
  ...
  "account.reverseShares.description":
    "Mit einer umgekehrten Freigabe können Sie eine eindeutige URL generieren, die es externen Benutzern ermöglicht, eine Freigabe zu erstellen.",
  ...
  "account.reverseShares.modal.max-use.description":
    "Die maximale Häufigkeit, mit der diese URL zum Erstellen einer Freigabe verwendet werden kann.",
  "account.reverseShares.table.no-shares":
    "Es wurden noch keine Freigaben erstellt",
  ...
  "admin.users.edit.delete.description":
    "Möchten Sie wirklich {Benutzername} und alle ihre Freigaben löschen?",
  ...
  "admin.users.modal.create.manual-password.description":
    "Wenn diese Option nicht aktiviert ist, erhält der Benutzer eine E-Mail mit einem Link zum Festlegen seines Passworts.",
  "admin.users.modal.create.admin": "Administratorrechte",
  "admin.users.modal.create.admin.description":
    "Wenn diese Option aktiviert ist, kann der Benutzer auf das Admin-Panel zugreifen.",
  "upload.title": "Hochladen",
  "upload.notify.generic-error":
    "Beim Abschließen der Freigabe ist ein Fehler aufgetreten.",
  "upload.notify.count-failed":
    "{count} filed konnte nicht hochgeladen werden. Versuchen Sie es erneut.",
  "upload.dropzone.title": "Dateien hochladen",
  "upload.dropzone.description":
    "Ziehen Sie Dateien per Drag & Drop hierher, um Ihre Freigabe zu starten. Wir können nur Dateien akzeptieren, die insgesamt kleiner als {maxSize} sind.",
