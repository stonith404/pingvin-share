export default {
  ...
  "navbar.links.reverse": "Pots communs",
  ...
  "account.reverseShares.title": "Pots communs",
  ...
  "account.reverseShares.description.empty": "Vous n'avez aucun pots communs.",
  ...
  "account.reverseShares.modal.send-email.description": "Envoyer une notification par courriel lorsqu'un partage est créé depuis ce pot commun.",
  ...
  "account.reverseShare.never-expires": "Ce pot commun n'expirera jamais.",
  "account.reverseShare.expires-on": "Ce pot commun expirera le {expiration}.",
  ...
  "account.reverseShares.modal.reverse-share-link": "Lien du pot commun",
  "account.reverseShares.modal.delete.title": "Supprimer le pot commun",
  ...
  "upload.notify.count-failed": "{count} fichier(s) n'a(ont) pu être téléversé(s). Essayez à nouveau.",
  // Dropzone.tsx
  ...
  "admin.config.email.enable-share-email-recipients.description": "Autorise les courriels des destinataires du partage. N'activez cette option que si vous avez activé SMTP.",
  "admin.config.email.share-recipients-subject": "Sujet des destinataires du partage",
  "admin.config.email.share-recipients-subject.description": "Sujet du courriel qui est envoyé aux destinataires du partage.",
  "admin.config.email.share-recipients-message": "Message des destinataires du partage",
  "admin.config.email.share-recipients-message.description": "Message qui est envoyé aux destinataires du partage. Variables disponibles :\n {creator} - Le surnom du créateur du partage\n {shareUrl} - L’URL du partage\n {desc} - La description du partage\n {expires} - La date d'expiration du partage\n Les variables seront remplacées par leur valeur réelle.",
  "admin.config.email.reverse-share-subject": "Sujet du pot commun",
  ...
  "admin.config.email.reverse-share-message": "Message du pot commun",
  "admin.config.email.reverse-share-message.description": "Message qui est envoyé lorsque quelqu'un créé un partage avec le lien de votre pot commun. {shareUrl} sera remplacé par le nom du créateur et l'URL de partage.",
  "admin.config.email.reset-password-subject": "Sujet de réinitialisation du mot de passe",
  "admin.config.email.reset-password-subject.description": "Sujet de lu courriel qui est envoyé lorsqu'un utilisateur demande une réinitialisation du mot de passe.",
  ...
  "admin.config.share.allow-unauthenticated-shares.description": "Autorise des utilisateurs non autentifiés à créer des partages",
  ...
  "admin.config.smtp.username": "Nom",
