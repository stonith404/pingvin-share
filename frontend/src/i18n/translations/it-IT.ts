export default {
  ...
  "admin.config.share.max-size.description": "Dimensione massima di condivisione",
  ...
  "admin.config.share.chunk-size.description": "Regola la dimensione del chunk per i tuoi caricamenti per bilanciare l'efficienza e l'affidabilità in base alla tua connessione internet. I chunk più piccoli possono migliorare i tassi di successo per connessioni instabili, mentre i chunks più grandi velocizzano i caricamenti per connessioni stabili.",
