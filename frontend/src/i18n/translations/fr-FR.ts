export default {
  ...
  "admin.config.oauth.github-client-id.description": "L’ID client de l’application OAuth GitHub",
  "admin.config.oauth.github-client-secret": "Secret client de GitHub",
  "admin.config.oauth.github-client-secret.description": "Le secret client de l’application OAuth GitHub",
  "admin.config.oauth.google-enabled": "Google",
  "admin.config.oauth.google-enabled.description": "Permettre la connexion via Google.",
  "admin.config.oauth.google-client-id": "L’ID client de Google",
  "admin.config.oauth.google-client-id.description": "L’ID client de l’application OAuth Google",
  ...
  "admin.config.oauth.microsoft-tenant.description": "ID Tenant de l'application OAuth Microsoft\nCommun : les utilisateurs ayant au choix un compte personnel ou d’entreprise issue de Microsoft Entra ID.\nOrganisations : limité aux utilisateurs ayant un compte d’entreprise ou d’université issue de Microsoft Entra ID.\nPublic : limité aux utilisateurs ayant un compte personnel\nDomanial : limité aux utilisateurs d'un domaine Microsoft Entra spécifié (au format GUID), qu'ils soient membres d'un registre d’entreprise ou d’université ou enregistrés en tant qu’invités avec un compte personnel.",
  "admin.config.oauth.microsoft-client-id": "ID du client Microsoft",
  "admin.config.oauth.microsoft-client-id.description": "ID client de l’application Microsoft OAuth",
  "admin.config.oauth.microsoft-client-secret": "Secret du client Microsoft",
  "admin.config.oauth.microsoft-client-secret.description": "Secret client de l’application Microsoft OAuth",
  ...
  "admin.config.oauth.oidc-client-id.description": "ID client de l’application OAuth OpenID",
  "admin.config.oauth.oidc-client-secret": "Secret du client OpenID",
  "admin.config.oauth.oidc-client-secret.description": "Secret client de l’application OAuth OpenID",
  // 404
