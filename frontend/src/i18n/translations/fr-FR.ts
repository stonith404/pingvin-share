export default {
  ...
  "account.modal.unlink.description": "Dissocier vos comptes sociaux peut vous faire perdre votre compte si vous ne vous souvenez pas de votre nom d'utilisateur et de votre mot de passe.",
  ...
  "upload.modal.expires.error.too-long": "L’expiration dépasse la date d'expiration maximale de {max}.",
  ...
  "admin.config.share.max-expiration.description": "Expiration maximale du partage en heures. Indiquez 0 pour ne jamais expirer.",
